...
# from packages.jobs.enrichers.enrich_geo_job import enriquecer_google_coords
# from packages.jobs.enrichers.enrich_cnpj_job import enriquecer_por_cnpj
...
#     return enriquecer_google_coords(payload.lead_ids)


# # 🧠 Enriquecimento por CNPJ
# async def enriquecer_cnpj(payload):
#     return enriquecer_por_cnpj(payload.lead_ids)
